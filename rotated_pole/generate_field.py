...
srcCellData = grid_mapper.createCellData(srcLats, srcLons)
...
dstCellData = grid_mapper.createCellData(dstLats, dstLons)
...
srcPointCube = iris.cube.Cube(srcPointData, var_name='nodal', standard_name='air_temperature', cell_methods=None)
...
dstPointCube = iris.cube.Cube(dstPointData, var_name='nodal', standard_name='air_temperature', cell_methods=None)
