...
EXPR = 'sin(2*pi*lons/180.)*cos(pi*lats/180.) + 0.*numpy.random.uniform(low=-0.5, high=0.5, size=lons.shape)'
...
def createPointData(lats, lons, expr=EXPR):
    """
...
def createCellData(lats, lons, expr=EXPR):
    """
